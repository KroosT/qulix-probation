    ...
    public static void main(final String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            mechanics.subscribe(new Observer() {
                ...
                @Override
                public void onDiscAppearedEvent() {
                    final StringBuilder event = new StringBuilder("Event: onDiscAppeared;")
                            .append(" Params: no params");
                    System.out.println(event);
                }

                @Override
                public void onDiscLostEvent() {
                    final StringBuilder event = new StringBuilder("Event: onDiscLost;")
                            .append(" Params: no params");
                    System.out.println(event);
                }
            });
